...
const Sidebar = ({ onSelect, activeItem }) => {
	...
	return (
		<div
			className={`flex h-screen flex-col bg-blue-600 text-white shadow-lg transition-all duration-300 
			...
			<div className="flex flex-col items-center gap-2 border-b border-blue-500 p-6">
				...
				<span
					className={`font-bold text-xl tracking-widest whitespace-nowrap ${isExpanded ? '' : 'transition-all duration-50 invisible'}`}>
					DAVANTE
				</span>
			</div>
