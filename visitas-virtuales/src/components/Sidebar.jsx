...
const Sidebar = ({ isMobileMenuOpen, setIsMobileMenuOpen }) => {
    ...
    const allMenuItems = [
        { id: 'landing', name: 'Inicio', icon: <Home size={22} />, path: '/' },
        { id: 'viewer', name: 'Visita 360°', icon: <Compass size={22} />, path: '/viewer' },
    ...
    windowSize.width < 1024 ? allMenuItems.splice(2, 0, { id: 'seleccion-centro', name: 'Selección de Centro', icon: <Building2 size={22} />, path: '/centros'}) : null;
