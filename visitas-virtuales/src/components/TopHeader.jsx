...
export default function TopHeader({onMenuClick}) {
    ...
    return (
        <header className="sticky top-0 z-40 h-16 w-full flex items-center justify-between p-4 lg:py-4 lg:px-8  lg:justify-end bg-slate-50/80 backdrop-blur-xl border-b border-blue-100/50
            ...
            <div className={`flex items-center ml-auto ${isStaff ? 'gap-6' : 'gap-4'}`}>
