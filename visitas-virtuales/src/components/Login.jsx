    ...
    <main className='main-content'>
        <section>
            ...
            <form onSubmit={handleSubmit} action="#" method="post">
                ...
                {!isCreateMode && (
                    <p>¿Aún no tienes cuenta?<a href='#' onClick={handleCreateAccount}>Crear cuenta.</a></p>
                )}

                {isCreateMode && (
                    <p>¿Ya tienes cuenta?<a href='#' onClick={handleBackToLogin}>Inicia sesión.</a></p>
                )}

                <button type="submit">{isCreateMode ? "Crear Cuenta" : "Login"}</button>
            </form>
        </section>
    </main>
    )
