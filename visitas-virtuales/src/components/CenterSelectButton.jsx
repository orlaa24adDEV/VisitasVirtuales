...
export default function CenterSelectButton({ centerName, onClick }) {
  return (
    <Button variant='outline' className="pl-2.5! rounded-lg! shadow-none! pr-3.75! pb-5! pt-5.5! hidden lg:flex gap-px leading-tight items-center justify-between" onClick={onClick}>
