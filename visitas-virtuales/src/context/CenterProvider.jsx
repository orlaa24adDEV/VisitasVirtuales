...
import { getLocalStorageAllCenters, setLocalStorageAllCenters, getLocalStorageSelectedCenter, setLocalStorageSelectedCenter, removeLocalStorageAllCenters, removeLocalStorageSelectedCenter } from '../helpers/centerLocalStorage.js';
  ...
  // Carga inicial de centros desde localStorage al montar el proveedor, para evitar parpadeos y llamadas innecesarias
    ...
    const fetchCenters = useCallback(async (providedToken = null) => {
      ...
      const value = useMemo(() => ({
        ...
        saveSelectedCenter,
        updateCenterImage,
      }), [centerState, fetchCenters, saveAllCenters, saveSelectedCenter, updateCenterImage]);
