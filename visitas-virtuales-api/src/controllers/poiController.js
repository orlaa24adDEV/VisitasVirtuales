...
export const updatePoiHandler = async (req,res) => {
  ...
  const updatedPoi = await poiService.updatePoi(userId, centerId, poiId, name, details)
  return res.json({ message: 'POI actualizado exitosamente', updatedPoi: updatedPoi })
}
...
export const deletePoiHandler = async (req, res) => {
  ...
  return res.json({ message: 'POI eliminado exitosamente', deletedPoi: deletedPoi });
}