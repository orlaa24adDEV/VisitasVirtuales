      ...
      <div className="relative border-l-2 border-blue-200 ml-4 md:ml-6">
        {commits.map((item) => (
          <div key={item.sha} className="mb-10 ml-6 group">
            ...
            <span className="absolute flex items-center justify-center w-4 h-4 bg-white border-2 border-blue-600 rounded-full -left-2.25 group-hover:bg-blue-600 transition-colors shadow-sm cursor-pointer">
            </span>
            ...
            <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm hover:shadow-md transition-all hover:-translate-y-1 cursor-pointer">
              ...
              <div className="flex items-center justify-between mt-4 pt-4 border-t border-slate-50">
                <div className="flex items-center gap-2">
                  <img 
                    src={item.author?.avatar_url || "https://github.com/identicons/j.png"} 
